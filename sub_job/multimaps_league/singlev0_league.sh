...
cd ~/uRTS_v2
python3 test_paralell_jin.py --envs-id fullgame-v0,fullgame-v0,fullgame-v0,fullgame-v0 --league Random,None,WorkerRush,Passive --num-process 4 --algo ppo -lr 1e-4  --ai1_socket Jin --ai2_socket Jin --render 0 --saving-prefix v0-league
