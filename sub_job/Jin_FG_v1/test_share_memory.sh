...
cd ~/uRTS_v2
python3 test_paralell_jin.py --envs-id fullgame-v0,fullgame-v1 --league Random,None --num-process 2 --algo ppo -lr 1e-4  --ai1_socket Jin --ai2_socket Jin --render 0 --saving-prefix test_share
