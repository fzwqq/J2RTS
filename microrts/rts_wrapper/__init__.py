        ...
        'kwargs': 
            {
                'config': Config(
                    ai1_type='socketAI',
                    ai2_type='Passive',
                    map_path=os.path.join(settings.map_dir, '6x6/HHome6x6.xml'),
                    height=6,
                    width=6,
                    max_cycles=1000,
                    max_episodes=1000,
        ...
        'kwargs':
            {
                'config': Config(
                    ai1_type='socketAI',
                    ai2_type='socketAI',
                    map_path=os.path.join(settings.map_dir, '4x4/fullgame4x4.xml'),
                    height=4,
                    width=4,
                    self_play=True,
                    # period=20,
        ...
        'kwargs':
            {
                'config': Config(
                    ai1_type='socketAI',
                    ai2_type='socketAI',
                    map_path=os.path.join(settings.map_dir, '4x4/baseResource4x4.xml'),
                    height=4,
                    width=4,
                    self_play=True,
                    # period=20,
        ...
        'kwargs':
            {
                'config': Config(
                    ai1_type='socketAI',
                    ai2_type='socketAI',
                    map_path=os.path.join(settings.map_dir, '4x4/base4x4base.xml'),
                    height=4,
                    width=4,
                    self_play=True,
                    # period=20,
