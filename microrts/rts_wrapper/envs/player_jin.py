from .utils_jin import signal_wrapper_v2, network_action_translator_v2, action_sampler_v3
from .utils import pa_to_jsonable,  get_action_index
from .player import Player


class PlayerJin(Player):
    ...
    def __init__(self, pid, client_ip, port, memory_size=10000):
        super(PlayerJin, self).__init__(pid, client_ip, port, memory_size)
    ...
    def act(self, action):
        ...
        action = network_action_translator_v2(action)
